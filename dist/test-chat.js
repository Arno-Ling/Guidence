...
async function testChatMemory() {
    ...
    // 模拟LLM回复
    chatManager.addAssistantMessage(sessionId, '你好！很高兴为你规划杭州自驾游。请问你计划什么时候出发？预算大概是多少？');
    ...
    chatManager.addAssistantMessage(sessionId, '好的！下周末杭州天气应该不错。3000元预算很充裕。你从哪里出发？计划玩几天？');
